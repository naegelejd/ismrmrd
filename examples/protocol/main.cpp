...
public:
    ...
    void session(tcp::socket sock)
    {
        ...
        while (true) {
            ...
            if (etype != ISMRMRD::ISMRMRD_ACQUISITION) {
            ...
            size_t nbytes = acq.getDataSizeInBytes();
...
int main(int argc, char* argv[])
{
    ...
    for (size_t i = 0; i < dataset.getNumberOfAcquisitions(); ++i) {
        ...
        uint32_t etype = ISMRMRD::ISMRMRD_ACQUISITION;
        ...
        boost::asio::write(sock, boost::asio::buffer(acq.getDataPtr(), acq.getDataSizeInBytes()));
